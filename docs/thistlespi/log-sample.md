...
* 在使用`slate-common`库的`SlfSpiLogger`输出日志时, SLF4J日志级别`INFO`, 日志包路径`sviolet.slate.common.util.spi`
...
SlfSpiLogger : 1 ThistleSpi |   type: sviolet.slate.common.utilx.txtimer.TxTimerProvider
SlfSpiLogger : 1 ThistleSpi |   implement: sviolet.slate.common.utilx.txtimer.def.DefaultTxTimerProvider
SlfSpiLogger : 1 ThistleSpi | -------------------------------------------------------------
SlfSpiLogger : 1 ThistleSpi | Service Applied:
SlfSpiLogger : 1 ThistleSpi |   type: cn.com.beeb.beet.scrunchy.core.BeanNameResolver
SlfSpiLogger : 1 ThistleSpi |   implement: cn.com.beeb.beet.scrunchy.core.DefaultBeanNameResolver
SlfSpiLogger : 1 ThistleSpi | -------------------------------------------------------------
SlfSpiLogger : 1 ThistleSpi | Service Applied:
SlfSpiLogger : 1 ThistleSpi |   type: cn.com.beeb.beet.common.util.trace.TraceProvider
SlfSpiLogger : 1 ThistleSpi |   implement: cn.com.beeb.beet.common.util.trace.DefaultTraceProvider
SlfSpiLogger : 1 ThistleSpi | -------------------------------------------------------------
SlfSpiLogger : 1 ThistleSpi | Loading plugins from META-INF/thistle-spi/, DOC: https://github.com/shepherdviolet/thistle
SlfSpiLogger : 1 ThistleSpi | -------------------------------------------------------------
SlfSpiLogger : 1 ThistleSpi ServiceLoader | Service sviolet.slate.common.utilx.txtimer.TxTimerProvider (sviolet.slate.common.utilx.txtimer.def.DefaultTxTimerProvider) loaded successfully
```
...
SlfSpiLogger: 1 ThistleSpi |   reason: Applied by level (application > platform > library)
SlfSpiLogger: 1 ThistleSpi | All Configurations:
SlfSpiLogger: 1 ThistleSpi |   + Service{id=beet-root-scrunchies, level=LIBRARY, impl=cn.com.beeb.beet.scrunchy.core.DefaultBeanNameResolver, url=file:/E:/C_Workspace/j2ee-3-test/beet-scrunchy-incubator/beet-scrunchy/out/production/resources/META-INF/thistle-spi/service.properties}
SlfSpiLogger: 1 ThistleSpi | -------------------------------------------------------------
SlfSpiLogger: 1 ThistleSpi | Service Applied:
SlfSpiLogger: 1 ThistleSpi |   type: cn.com.beeb.beet.common.util.trace.TraceProvider
SlfSpiLogger: 1 ThistleSpi |   implement: cn.com.beeb.beet.common.util.trace.DefaultTraceProvider
...
SlfSpiLogger: 1 ThistleSpi |   reason: Applied by level (application > platform > library)
SlfSpiLogger: 1 ThistleSpi | All Configurations:
SlfSpiLogger: 1 ThistleSpi |   + Service{id=beet-root-common, level=LIBRARY, impl=cn.com.beeb.beet.common.util.trace.DefaultTraceProvider, url=file:/E:/C_Workspace/j2ee-3-test/beet-scrunchy-incubator/beet-common/out/production/resources/META-INF/thistle-spi/service.properties}
SlfSpiLogger: 1 ThistleSpi | -------------------------------------------------------------
SlfSpiLogger: 1 ThistleSpi | Loading plugins from META-INF/thistle-spi/, DOC: https://github.com/shepherdviolet/thistle
